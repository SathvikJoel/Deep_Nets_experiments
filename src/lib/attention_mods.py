'''
Modules for attention mechansm
'''
...
# Stem 
# Context based mechanisms underperfrom at the stem so a different treatment is required at the stem
# check ` Replacing the convolutinal stem section of the paper `
