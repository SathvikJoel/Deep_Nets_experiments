...
# This is a standard resnet implementation
# Every 2nd convolution in a bottelneck is replaced by a attention conv
...
def ResNet26(num_classes=10, stem=False):
    return Model(Bottleneck, [1, 2, 4, 1], num_classes=num_classes, stem=stem)


def ResNet38(num_classes=10, stem=False):
